...
class GuistHomePage extends StatelessWidget {
  GuistHomePageController controller = Get.find();
  @override
                  ...
                  child: Padding(
                      ...
                      child: Obx(() {
                        return ListView.builder(
                          itemCount: controller.Listclass.value.length,
                                    ...
                                    child: Padding(
                                        ...
                                        child: InkWell(
                                            ...
                                            child: Column(children: [
                                              Text(
                                                  '${controller.Listclass.value[index].name}',
                                                  style: TextStyle(
